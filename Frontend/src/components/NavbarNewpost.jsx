...
const Navbar = () => {
  return (
    <div className='h-[20%] flex lg:justify-between md:justify-between items-center text-green-500 md:p-10 lg:p-10 justify-between p-3  '>
        ...
        <Link to="/" className='flex justify-center items-center bg-green-600 text-black p-3 border-black rounded-full sm:'><h2 className='font-bold text-center'>Home</h2></Link>
    </div>
  )
}
